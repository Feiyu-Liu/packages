...
class PlatformZoomCapabilities {
  ...
  static PlatformZoomCapabilities decode(Object result) {
    ...
    return PlatformZoomCapabilities(
      ...
      currentZoomFactor: result[2]! as double,
      displayZoomFactorMultiplier: result[3]! as double,
      virtualDeviceSwitchOverZoomFactors: (result[4]! as List<Object?>).cast<double>(),
      secondaryNativeResolutionZoomFactors: (result[5]! as List<Object?>).cast<double>(),
      isVirtualDevice: result[6]! as bool,
      constituentDevices: (result[7]! as List<Object?>).cast<PlatformConstituentDevice>(),
    );
  }
